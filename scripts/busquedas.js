			...
			twOft += '</a>';
                        ...
                        if(idEmp){
							...
							$(".logoOferta2 img").error(function() {
                                                            $(this).attr("src", "imgs/ofrtTemp/logo-temporal.jpg");
								//$(this).hide();
							});
                            $.get('wssucs',{id:idEmp},function(sucursales){
                                ...
                                if(sucursales.length >= 1){  
                                    $("#sucursales").prepend('<div class="col-10 bgRd marg-T10px sucsText"><h4 class=" typ-Wh"> Sucursales con esta oferta</h4></div>');
                        ...
                        if(imgurl)
                            $("#imgOftLb").html('<img class="img" src="'+imgurl+'" style="max-width: 400px; max-width: 400px;"/>');
                        else
                        $("#imgOftLb").html('');
